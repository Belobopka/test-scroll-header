          ...
          return (
            <ScrollView
              style={[
                ...
                {
                  ...props.style,
                  //  marginBottom: interpolatedValue,
                  // paddingTop: interpolatedValue.interpolate({
              ...
              // onScrollBeginDrag={() => {
              //   console.log("ref?.current?.paddingTop", ref?.current);
              //   if (ref?.current?.paddingTop < maxHeight) {
              //   }
              // }}
              onScroll={(event) => {
